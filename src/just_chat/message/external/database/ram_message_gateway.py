...
from just_chat.message.application.interfaces.message_gateway import MessageGateway, MessageNotFoundError
from just_chat.message.domain.message import Message, MessageId
